  ...
  return (
    <footer className="mt-16 border-t border-slate-800 bg-slate-900 text-slate-200">
      <div className="mx-auto max-w-7xl px-4 py-10">
              ...
              <div className="mt-5 flex justify-center gap-3 md:justify-start">
                {settings.instagramUrl && (
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-700 text-slate-300 transition hover:border-emerald-500 hover:text-emerald-400"
                  >
        ...
        <p className="mt-10 border-t border-slate-800 pt-6 text-center text-xs text-slate-500 md:text-left">
