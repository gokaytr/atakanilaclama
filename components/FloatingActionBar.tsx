  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 flex border-t border-black/10 bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.08)] md:hidden">
      <a
        ...
        className="flex flex-1 items-center justify-center gap-2 bg-green-600 py-3 text-sm font-semibold text-white"
      >
        💬 WhatsApp
      </a>
      <a
        href={buildTelLink()}
        className="flex flex-1 items-center justify-center gap-2 bg-red-600 py-3 text-sm font-semibold text-white"
      >
